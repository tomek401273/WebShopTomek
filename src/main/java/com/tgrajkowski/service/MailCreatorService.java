...
public class MailCreatorService {
    ...
    public String create(Mail mail) {
        ...
        return templateEngine.process("newsletter-mail", context);
    }
    ...
    private String confirmNewsletter(Mail mail, Context context) {
        ...
        String confirmationLink = webShopConfig.getFrontedLink() + "newsletter/confirm?email=" + mail.getMailTo() + "&code-confirm=" + mail.getConfirmCode();
        ...
        return templateEngine.process("confim-newsletter", context);
    }
