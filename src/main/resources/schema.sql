-- INSERT INTO public.photo(id, content_type, filte_byte, name) VALUES (1, 'jpeg', lo_import('/home/tomasz/Obrazy/spock.jpg'), 'tom');
-- INSERT INTO public.photo(id, content_type, filte_byte, name) VALUES (1, 'jpeg', lo_import(PGconn *conn, const char *spock.jpg), 'tom');
SELECT * FROM  photo;
