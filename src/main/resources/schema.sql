...
# ('thomas', 'thomas', '$2a$10$Nijs1aGPCtgEGNzkDpabB./aeTTUUz6D3Lrc8YLNw2hFRjr.X/89i', 'thomas');
# INSERT INTO user (login, name, password, surname) VALUES
# ('user', 'user', '$2a$10$N8FgXP.nt0fU1ta0XvmaNunxzaANB8UxFQv.2HNrea6eiUXTyqXfm', 'user');
#
...
#
# INSERT INTO product (image_link, available_amount, description, price, title, total_amount) VALUES ('https://i.ebayimg.com/00/s/NTQzWDQxNQ==/z/X-IAAOSweDdaoUD1/$_86.JPG', 100, 'Samsung Galaxy S9', 100, 'Galaxy S9', 100);
# INSERT INTO product (image_link, available_amount, description, price, title, total_amount) VALUES ('https://www.att.com/catalog/en/skus/images/apple-iphone%20x-space%20gray-450x350.png', 100, 'super iphone iphone', 100, 'iphone10', 100);
# INSERT INTO product (image_link, available_amount, description, price, title, total_amount) VALUES ('http://nusignsupply.com/store/images/detailed/1/flatbed-front.jpg', 100, 'Super Printer', 100, 'Super Printer', 100);
# INSERT INTO product (image_link, available_amount, description, price, title, total_amount) VALUES ('https://image3.mouthshut.com/images/imagesp/925872676s.jpg', 100, 'Printer printer Cannon Printer', 100, 'Printer', 100);
# INSERT INTO product (image_link, available_amount, description, price, title, total_amount) VALUES ('https://assets.letemps.ch/sites/default/files/media/2018/01/19/file6yhesfeuttf1awwjugk.jpg', 100, 'Super Server', 100, 'Super Server', 100);
# INSERT INTO product (image_link, available_amount, description, price, title, total_amount) VALUES ('http://dataekb.ru/wp-content/uploads/2017/05/types-of-web-hosting-servers.jpg', 100, 'Server Server', 100, 'Server', 100);
# INSERT INTO product (image_link, available_amount, description, price, title, total_amount) VALUES ('https://static.pexels.com/photos/204611/pexels-photo-204611.jpeg', 100, 'Ultra Computer with Windows', 100, 'Ultra Compupter', 100);
# INSERT INTO product (image_link, available_amount, description, price, title, total_amount) VALUES ('https://des.gbtcdn.com/uploads/pdm-desc-pic/Electronic/image/2016/04/21/1461210911561985.jpg', 100, 'Standard Windows Computer', 100, 'Standard Comp', 100);
# INSERT INTO product (image_link, available_amount, description, price, title, total_amount) VALUES ('http://www.ex-astris-scientia.org/inconsistencies/monitors/monitor-tos-shine-theparadisesyndrome.jpg', 100, 'Super Spocks Computer', 100000, 'Spocks Computer', 100);
# INSERT INTO product (image_link, available_amount, description, price, title, total_amount) VALUES ('https://static.pexels.com/photos/204611/pexels-photo-204611.jpeg', 100, 'super computer computer', 200000, 'Super Comp', 100);
# INSERT INTO product (image_link, available_amount, description, price, title, total_amount) VALUES ('http://trojmiasto.wizytowka.waw.pl/wp-content/uploads/2017/11/dron-trojmiasto-bytow.jpg', 100, 'Super Dron Dron', 23000, 'Dron', 100);
# INSERT INTO product (image_link, available_amount, description, price, title, total_amount) VALUES ('http://kaka.com.ng/image/data/layerslider/iphone%206.jpg', 100, 'super iphone iphone', 20000, 'iphone6', 100);
#
